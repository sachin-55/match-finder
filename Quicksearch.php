...
else
{
  ...
  $age1=get_post($conn, $_POST['age3']);
  $age2=get_post($conn, $_POST['age4']);
  ...
  $district="";
		...
		$district=get_post($conn, $_POST['district7']);
			...
			WHERE gender='$looking' and lookfor='$sex'and status='1' and userr_l1.uid!='$uid' and state='$state' and district='$district' and religion='$religion'";
...
<table id="table">
	...
	<tr><td><br>Religion &nbsp;</td><td><br>
			...
			<option value="other">Others</option></td></tr>

			<tr><td><br>Resident State &emsp;</td><td><br>
		...
		<tr><td></td><td><br><input id="btn" type="submit" name="submitbtn4" value="Search"></td></tr>
